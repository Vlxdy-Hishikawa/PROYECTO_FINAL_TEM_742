...
<html lang="es">
    ...
    <body>     
        ...
        <c:if test="${hoja.id_hoja_ruta != 0}">
                <h1 align="center">MODIFICAR DATOS DEL DOCUMENTO  "${hoja.descripcion}"  </h1>
        </c:if>
            <form action="HojaControlador" method="post" enctype="multipart/form-data">
                <h3 align="center">
                <c:if test="${hoja.id_hoja_ruta == 0}">
                ...
                <input type="hidden" name="aux" value="${hoja.id_tramitador}"/>
            <table>
                <tr>
                    <td>ENCARGADO</td>
                        <td>
