...
<html lang="es">
    ...
    <body>
        <h1>LISTADO DE HOJA DE RUTA</h1>
        <p><a href="id_tramitador?action=add" class="btn"><img src="2.png" title="Nuevo registro"/>NUEVO</a></p>
            ...
            <div class="tbl-content">
                ...
                <c:forEach var="item" items="${hoj}">        
                    <tr>
                        ...
                        <td><a  href="HojaControlador?action=edit&id=${item.id_hoja_ruta}" onclick="return(confirm('ESTA SEGURO DE EDITAR EL DATO DEL DOCUMENTO DE ${item.descripcion}  ??'))" class="btn1"><img src="4.png" width="18" title="Modificar"/></a></td>
                        <td><a  href="HojaControlador?action=delete&id=${item.id_hoja_ruta}" onclick="return(confirm('ESTA SEGURO DE ELIMINAR EL DATOS DEL DOCUMENTO DE ${item.descripcion} ??'))" class="btn2"><img src="3.png" width="18" title="Eliminar"/></a></td>
                    </tr>
                </c:forEach>
               </tbody>
    </table>
